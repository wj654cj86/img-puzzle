var latinScript = {
	...
	'C': ['m81,25l7.071-7.071a45,45,270,1,0,0,63.6396l-7.071-7.071a35,35,270,1,1,0-49.4975z'],
	...
	'G': ['m81,25l7.071-7.071a45,45,270,1,0,0,63.6396l-7.071-7.071a35,35,270,1,1,0-49.4975z', 'm50,45h40v50h-10v-40h-30z'],
	...
	'K': ['m15,5h10v90h-10z', 'm70,5h15l-68,60v-13.2353z', 'm29,42h13l43,53h-13z'],
	'L': ['m15,5h10v80h60v10h-70z'],
	'M': ['m10,5h10v90h-10z', 'm80,5h10v90h-10z', 'm20,5l34,60l-4,12l-34-60z', 'm80,5l-34,60l4,12l34-60z'],
	...
	'V': ['m15,5h12l29,85h-12z', 'm85,5h-12l-29,85h12z'],
	'W': ['m5,5h10l20,90h-10z', 'm45,5h10l-20,90h-10z', 'm95,5h-10l-20,90h10z', 'm55,5h-10l20,90h10z'],
	'X': ['m15,5h11l59,90h-11z', 'm15,95h11l59-90h-11z'],
	'Y': ['m15,5h11l28,42v16.5z', 'm85,5h-11l-28,42v16.5z', 'm45,48h10v47h-10z'],
...
function latinnew(ls, gn, svg, fill) {
...
function coordinatestyle(x, y) {
	...
	latinnew(x, 0, svg, '#5a5');
	latinnew(y, 1, svg, '#949');
